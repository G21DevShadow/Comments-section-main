...
export function IconUpdate({ handleClick }: prop) {
  return (
    <a
      href="#"
      className="flex gap-1 items-center h-fit text-sm text-Moderate-blue fill-Moderate-blue hover:text-Light-grayish-blue hover:fill-Light-grayish-blue duration-200"
      onClick={(e) => {
        e.preventDefault();
        handleClick();
      }}
